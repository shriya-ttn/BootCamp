...
public class Q5SortEmployee {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee("Ravi", 25d, 45000d);
        Employee employee2 = new Employee("Anisha", 22d, 25000d);
        Employee employee3 = new Employee("Himani", 20d, 15000d);
...
//        Sorting By Salary
        ...
        while (iterator.hasNext())
        {
            ...
            System.out.println("Name-"+e.employeeName+" ; Age-"+e.employeeAge+" ; Salary-"+e.employeeSalary);
        }
